        ...
        <div className="card-grid">
          <div className="card">
            ...
            <div className="card-footer">
              <Link className="btn" to="posts.html">
                View
              </Link>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="card-preview-text">
                ...
                voluptatem doloribus vel accusantium quis pariatur molestiae
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="card-preview-text">
                repudiandae veniam quaerat sunt sed alias aut fugiat sit autem
                sed est voluptatem omnis possimus esse voluptatibus quis est aut
                tenetur dolor neque
              </div>
            </div>
            <div className="card-footer">
